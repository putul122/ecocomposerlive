...
import EditRoles from '../../containers/editRoles/editRolesContainer'
import LeftNavigation from '../../components/leftNavigation/leftNavComponent'
import Header from '../../containers/header/headerContainer'
import FooterComponent from '../../components/footer/footerComponent'

class EditRolesPageRoute extends React.Component {
	render () {
		return (
  <div>
    <Header {...this.props} />
...
export default EditRolesPageRoute
